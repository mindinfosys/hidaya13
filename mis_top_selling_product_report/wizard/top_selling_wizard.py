...
class TopSellingWizard(models.TransientModel):
    ...
    def print_report(self):
        ...
        data = {'date': self.date, 'least': self.least, 'from_date': self.from_date,
                'to_date': self.to_date, 'company': company_id, 'warehouse': warehouse_id}

        return self.env.ref('mis_top_selling_product_report.top_selling_pdf').report_action(self, data=data)
